...
export function Summary() {
  ...
  const { parts, colors, buildName, missionType, calcs } = useDroneState()
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              <div className="flex items-center gap-2 mb-1">
                <Link to="/configurator" className="text-industrial-muted hover:text-industrial-fg transition-colors">
                  <ChevronLeft size={16} />
                </Link>
              ...
              {[
                ...
                <div key={i} className="flex justify-between items-center py-2.5 border-b border-industrial-border/50 last:border-b-0">
                  <div>
                    ...
                    <div className="text-[10px] font-mono text-industrial-muted mt-0.5">{item.detail} · {item.weight}g</div>
                  </div>
                  <div className="font-mono text-xs text-industrial-fg-secondary">${item.price}</div>
                </div>
              ))}
            </div>
            ...
            <div className="border border-industrial-border p-5 mb-6 bg-industrial-surface/10">
              ...
              <div className="flex gap-3 mt-6">
                <Link to="/checkout" className="flex-1">
                  <Button variant="primary" className="w-full font-mono text-[10px] uppercase justify-center">
                    <Calendar size={14} /> Reservar Este Drone
                  </Button>
                </Link>
                <Link to="/configurator" className="flex-1">
                  <Button variant="secondary" className="w-full font-mono text-[10px] uppercase justify-center">
                    Editar Configuração
                  </Button>
                </Link>
              </div>
